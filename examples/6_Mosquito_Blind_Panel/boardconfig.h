 ...
 */ 
    ...
    */
    ...
    #define AIRSPEED_STEPPER_PIN3     4
    #define AIRSPEED_STEPPER_PIN4     5
    #define AIRSPEED_ZERO_PIN         6

    // Artificial Horizon
    #define AHORIZON_BANK_SERVO_PIN   7
    #define AHORIZON_PITCH_SERVO_PIN  8

    // Rate of Climb Indicator
    #define ROCLIMB_STEPPER_PIN1      22
    #define ROCLIMB_STEPPER_PIN2      24
    #define ROCLIMB_STEPPER_PIN3      26
    #define ROCLIMB_STEPPER_PIN4      28
    #define ROCLIMB_ZERO_PIN          30

    // Altimeter
    #define ALTIMETER_STEPPER_PIN1    23
    #define ALTIMETER_STEPPER_PIN2    25
    #define ALTIMETER_STEPPER_PIN3    27
    #define ALTIMETER_STEPPER_PIN4    29
    #define ALTIMETER_ZERO_PIN        31

    // Gyroscopic Directional Indicator (DI)
    #define DI_STEPPER_PIN1           41
    #define DI_STEPPER_PIN2           43
    #define DI_STEPPER_PIN3           45
    #define DI_STEPPER_PIN4           47
    #define DI_ZERO_PIN               49

    // Side Slip and Turn Gauge
    #define SIDESLIP_SERVO_PIN        10
    #define TURN_SERVO_PIN            11
#else
